...
window.onload = function () {
    var imageContainer = document.querySelector("#outputImage");
    var myImageString = "<figure>";

    for (var i = 0; i < images.length; i++) {
        myImageString += "<img src=" + images[i].url + " alt=" + images[i].alt +
        " title=" + images[i].caption + "/>" + "<figcaption>" + images[i].caption + "</figcaption>";

    }
    myImageString += "</figure>";
    imageContainer.innerHTML = myImageString;
};
