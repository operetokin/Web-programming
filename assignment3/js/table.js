...
window.onload = function () {
    ...
    var myTableString = '<table border="1">' + '<tr>' + '<th>' + 'First Name' + '</th>' + '<th>' + 'Last Name' + '</th>' + '<th>' + 'Age' + '</th>' + '<th>' + 'Email' + '</th>';

    for (var i = 0; i < users.length; i++) {
        myTableString += "<tr>" + "<td>" + users[i].first_name + "</td>" + "<td>" + users[i].last_name + "</td>" + "<td>" + users[i].age + "</td>" + "<td>" + "<a href = 'mailto:" + users[i].email + "'>" + users[i].email + "</a>" + "</td>" + "</tr>";
    }
    myTableString += "</table>";
    tableContainer.innerHTML = myTableString;
};
